    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">{t('common.privacy')}</h1>
                    <p className="text-gray-500">Manage privacy policy content</p>
                </div>
                {!isEditing && (
                    <button
            ...
            {isEditing ? (
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6">
                    <div className="flex justify-between items-center">
                        <h2 className="text-lg font-semibold text-gray-900">Edit Privacy Policy</h2>
                        <button
                    ...
                    >
                        {content[isRTL ? 'ar' : 'en'] ? (
                            ...
                            <p className="text-gray-500 italic">
                                No privacy policy content available. Click "Edit" to add content.
                            </p>
                        )}
                    </div>
                </div>
